...
#define tempoFeuOff_ZA4 2000 //ZA4
...
//Commande aiguillage Malemort
#define ETAT_AIG_Malemort 46
...
//Actions
#define Tulle 1  //Sens vers Tulle
#define Brive 0  //Sens vers Brive
#define SensStop 0 //Sens stop

#define Marche 1 //Mise en marche
#define Arret 0  //Mise en arret
...
boolean etatAiguilleMalemort = 0;  //Etat de la commande d'aiguille Malemort
int currentEtatAiguilleMalemort = 0;  //Etat de l'aiguille Malemort
uint8_t aigCurrent = 111;  //Aiguille courante
boolean currentAigChanged = false;  //Flag séquence changé
